...
<html lang="en">
	<head>
		...
		<title> Vertical Menu Navigation - Collapse and Dark Mode Example </title>
			  <!-- Style CSS -->
		...
		<nav class="sidebar close">
		  <header>
			<div class="image-text"> 
				<a href="javascript:void();" onclick="alert('hello');" class="text-logo-a">
				<span class="image">
			  ...
			  <ul class="menu-links">
				...
				<li class="nav-link">
				  <a href="javascript:void();" onclick="loadPage('pages/patient.php?patientid=0', 'content');">
					...
					<span class="text nav-text">Patient Entry</span>
				  </a>
				</li>
				<li class="nav-link">
				  <a href="javascript:void();">
